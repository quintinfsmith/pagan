...
class SampleHandleGenerator(var sample_rate: Int, var buffer_size: Int) {
    ...
    fun generate_new(note: Int, bend: Int, sample_directive: SampleDirective, global_sample_directive: SampleDirective, instrument_directive: InstrumentDirective, global_instrument_directive: InstrumentDirective, linked_handle_count: Int = 1): SampleHandle {
        ...
        val filter_cutoff: Float = (sample_directive.filter_cutoff ?: global_sample_directive.filter_cutoff ?: 13500F ) + (instrument_directive.filter_cutoff ?: 0F) + (global_instrument_directive.filter_cutoff ?: 0F)
        this.generated += 1
        ...
        return SampleHandle(
            ...
            loop_points = if (sample_directive.sampleMode != null && sample_directive.sampleMode!! and 1 == 1) {
                ...
                val end = sample_directive.sample!!.loopEnd + (sample_directive.loopEndOffset ?: 0) + (global_sample_directive.loopEndOffset ?: 0)

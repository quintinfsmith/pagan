...
class PlaybackFrameMap(val opus_manager: OpusLayerBase, private val _sample_handle_manager: SampleHandleManager): FrameMap {
    ...
    private val artificial_pitch_shifts = HashMap<Pair<Int, Int>, PitchController>()
    ...
    fun clear() {
        ...
        this.artificial_pitch_shifts.clear()
        ...
        this.opus_manager.get_all_channels().forEachIndexed { c: Int, channel: OpusChannelAbstract<*, *> ->
            ...
            channel.lines.forEachIndexed { l: Int, line: OpusLineAbstract<out InstrumentEvent> ->
                ...
                if (!ignore_line_controls) {
                    ...
                    // Apply Pitch shifting generated by Velocity Controller
                    this.artificial_pitch_shifts[Pair(c, l)]?.let {
                        temp_data.add(
                            Quad(
                                FrameMap.LAYER_LINE,
                                PlaybackFrameMap.generate_merge_keys(c, l)[FrameMap.LAYER_LINE],
                                it.generate_profile(),
                                EffectType.Pitch,
                            )
                        )
            ...
            if (working_note_end == offset) {
                ...
                pitch_controller.set_event(
                    ...
                    PitchEvent(
                        ...
                        duration = 1, // TODO //adj_transition_width.numerator * new_size / adj_transition_width.denominator,

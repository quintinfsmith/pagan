...
import com.qfs.pagan.structure.opusmanager.base.effectcontrol.effectcontroller.BandPassController
    ...
    fun new_controller(type: EffectType, controller: EffectController<*>? = null) {
        if (controller == null) {
            this.controllers[type] = when (type) {
                ...
                EffectType.BandPass -> BandPassController(this.beat_count)
            }
        } else {
